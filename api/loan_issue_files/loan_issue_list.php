...
$query = "SELECT le.id AS loan_entry_id, cc.id , cc.cus_id ,  CONCAT(cc.first_name, ' ', COALESCE(cc.last_name, '')) AS cus_name, cc.aadhar_number , lc.loan_category , le.loan_amount , le.loan_date , le.cus_data , anc.areaname , lnc.linename , bc.branch_name , cc.mobile1, cs.id as cus_sts_id,  cs.status as c_sts
