...
$qry = $pdo->query("INSERT INTO `expenses`(`collection_mode`, `bank_id`, `invoice_id`, `branch`, `expenses_category`, `agent_id`, `total_issued`, `total_amount`, `description`, `amount`, `trans_id`, `insert_login_id`, `created_on`) VALUES ('$collection_mode','$bank_id','$invoice_id','$branch_name','$expenses_category','$agent_name','$expenses_total_issued','$expenses_total_amnt','$description','$expenses_amnt', '$expenses_trans_id','$user_id',now() )");
