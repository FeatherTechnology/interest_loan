<div class="row gutters">
    <div class="col-12">
        <div class="col-12 text-right">
            ...
            <button class="btn btn-primary back_to_loancategory_btn" tabindex="25" style="display: none;"><span class="icon-arrow-left"></span> Back</button>
        </div></br>
                ...
                <div class="row gutters">
                    <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="profit_type_calc" name="profit_type_calc" value="Calculation" tabindex="4" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="due_method" name="due_method" value="Monthly" tabindex="5" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-4">
                                        <div class="form-group">
                                            <label for="due_type">Due Type</label><span class="text-danger">*</span>
                                            <input type="text" class="form-control" id="due_type" name="due_type" tabindex="6" value="Interest" readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-4">
                                        <div class="form-group">
                                            <label for="benefit_method">Benefit Method</label><span class="text-danger">*</span>
                                            <input type="text" class="form-control" id="benefit_method" name="benefit_method" value="After Benefit" tabindex="7" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-3 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="due_period" name="due_period" placeholder="Enter Due Period" tabindex="8">
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-4">
                                        <div class="form-group">
                                            <label for="interest_calculate">Interest Calculate</label><span class="text-danger">*</span>
                                            <select class="form-control" id="interest_calculate" name="interest_calculate" tabindex="9">
                                    ...
                                    <div class="col-md-3 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="due_calculate" name="due_calculate" value="On Date" tabindex="10" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control interest_minmax" id="interest_rate_min" name="interest_rate_min" tabindex="11" placeholder="Enter Min Interest Rate">
                                    ...
                                    <div class="col-md-3 col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control form-group-label-emptywith-input interest_minmax" id="interest_rate_max" name="interest_rate_max" tabindex="12" placeholder="Enter Max Interest Rate">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-4 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="doc_charge_type" id="docpercentage" value="percentage" tabindex="13" checked>
                                            <label for="docpercentage">&nbsp;&nbsp;<b>%</b></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                            <input type="radio" name="doc_charge_type" value="rupee" id="docamt" tabindex="14">
                                            <label for="docamt">&nbsp;&nbsp;₹</label>
                                            <div class="input-group">
                                                <input type="number" class="form-control doc_charge_minmax" id="doc_charge_min" name="doc_charge_min" tabindex="15" placeholder="Enter Min Document Charge">
                                                <div class="input-group-append">
                                    ...
                                    <div class="col-md-3 col-sm-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control form-group-label-emptywith-input doc_charge_minmax" id="doc_charge_max" name="doc_charge_max" tabindex="16" placeholder="Enter Max Document Charge">
                                                <div class="input-group-append form-group-label-emptywith-input">
                                                    <span class="input-group-text document-span-val">%</span>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-4 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="radio" name="process_fee_type" value="rupee" id="procamt" tabindex="18">
                                            <label for="procamt">&nbsp;&nbsp;₹</label>
                                            <div class="input-group">
                                                <input type="number" class="form-control processing_minmax" id="processing_fee_min" name="processing_fee_min" tabindex="19" placeholder="Enter Min Processing Fee">
                                                <div class="input-group-append">
                                    ...
                                    <div class="col-md-3 col-sm-4 mt-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control form-group-label-emptywith-input processing_minmax" id="processing_fee_max" name="processing_fee_max" tabindex="20" placeholder="Enter Max Processing Fee">
                                                <div class="input-group-append form-group-label-emptywith-input">
                                                    <span class="input-group-text process-span-val">%</span>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-4 mt-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control overdue_minmax" id="overdue_penalty" name="overdue_penalty" tabindex="22" placeholder="Enter Overdue Penalty">
                                                <div class="input-group-append">
                        ...
                        <div class="col-12 mt-3 text-right">
                            <button name="submit_loan_category_creation" id="submit_loan_category_creation" class="btn btn-primary" tabindex="23"><span class="icon-check"></span>&nbsp;Submit</button>
                            <button type="reset" id="clear_loan_cat_form" class="btn btn-outline-secondary" tabindex="24">Clear</button>
                        </div>
    ...
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content" style="background-color: white">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="addloan_category_name" id="addloan_category_name" tabindex="1" placeholder="Enter Loan Category">
                                <input type="hidden" id="addloan_category_id" value='0'>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                            <div class="form-group">
                                <button name="submit_addloan_category" id="submit_addloan_category" class="btn btn-primary" tabindex="1" style="margin-top: 18px;"><span class="icon-check"></span>&nbsp;Submit</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-secondary" data-dismiss="modal" tabindex="1" onclick="getLoanCategoryDropdown()">Close</button>
            </div>
        </div>
    </div>
</div>
